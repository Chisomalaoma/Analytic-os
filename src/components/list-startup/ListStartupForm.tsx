        ...
        try {
            const res = await fetch('/api/admin/tokens', {
                ...
                body: JSON.stringify({
                    ...
                    contractAddress: null, // Auto-generated by backend
            ...
            if (data.success) {
                setSuccess('Someone from our finance team will reach out to you shortly.')
                setTimeout(() => {
        ...
        <form className="bg-transparent" onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    />
                    <p className="text-xs text-gray-500 mt-1">Fixed to Monthly for all listings</p>
                </div>
                <div>
                ...
                <div className="md:col-span-2">
                    ...
                    <input 
                        ...
                        disabled
                        className="w-full bg-gray-800 border border-gray-600 rounded-lg px-4 py-3 text-gray-400 cursor-not-allowed font-mono text-sm" 
                    />
                    <p className="text-xs text-gray-500 mt-1">System will auto-generate blockchain contract address</p>
                </div>
            </div>
            <div className="mt-6">
